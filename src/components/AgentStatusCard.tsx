    ...
    <Card>
      <div className="space-y-4">
        ...
        <div className="grid grid-cols-2 gap-3">
          ...
          <div className="flex items-center gap-2">
            <div className="w-3.5 h-3.5 text-zinc-500 text-xs font-bold flex items-center justify-center">
              T
            </div>
            <div>
          ...
          <div className="flex items-center gap-2">
            <AlertTriangle
              className={cn(
                "w-3.5 h-3.5",
                errorCount > 0 ? "text-red-400" : "text-zinc-500",
              )}
            />
            <div>
              ...
              <p
                className={cn(
                  "text-sm font-medium",
                  errorCount > 0 ? "text-red-400" : "text-zinc-300",
                )}
              >
                {errorCount}
              </p>
